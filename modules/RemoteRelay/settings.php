					...
					<div class="box-content">
						...
						<fieldset>
							<legend>Module Settings</legend>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input type="radio" name="relays_off_deactivation" value="1" <?php if ($settings_array['relays_off_deactivation'] == "1") { echo 'checked="checked"'; } ?>><span> Yes </span>
								  <input type="radio" name="relays_off_deactivation" value="0" <?php if ($settings_array['relays_off_deactivation'] == "0") { echo 'checked="checked"'; } ?>><span> No </span>
								</div>
						...
						<hr>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input type="radio" name="relays_gpio_active_state" value="high" <?php if ($settings_array['relays_gpio_active_state'] == "high") { echo 'checked="checked"'; } ?>><span> Active High </span>
								  <input type="radio" name="relays_gpio_active_state" value="low" <?php if ($settings_array['relays_gpio_active_state'] == "low") { echo 'checked="checked"'; } ?>><span> Active Low </span>
								</div>
